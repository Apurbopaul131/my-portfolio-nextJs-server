...
const createProjectValidationSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        futureScope: zod_1.z.string().min(1, 'Future scope is required'),
        challenges: zod_1.z.string().min(1, 'Challenges are required'),
...
const updateProjectValidationSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        futureScope: zod_1.z.string().min(1, 'Future scope is required').optional(),
        challenges: zod_1.z.string().min(1, 'Challenges are required').optional(),
